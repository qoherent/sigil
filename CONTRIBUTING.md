...
| `integrations/skills/` | Three source-based 0.8 design skills, the `sigil-egglog` language skill, plus the legacy `sigil` 0.7 native workflow | Shared language pack and evaluator-owned review contract; models execute in the host. |
