...
| `@qoherent/core`  | 1.0.0   | config 1.0.0; language 1.0.0             |
| `@qoherent/cli`   | 1.0.0   | core `^1.0.0`                            |
| `@qoherent/lsp`   | 1.0.0   | core `^1.0.0`; LSP 3.18                  |
| VS Code extension | 1.0.0   | `@qoherent/lsp` 1.x; VS Code `^1.91.0`    |
