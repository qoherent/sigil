...
The requested component has implementation, tests, and conflicting documentation.
...
4. Explain what the evidence supports and begin a focused conversation for the
   missing application purpose, users or systems, boundary, and external
   interaction surfaces.
5. Continue with targeted follow-up questions while material RootSigil decisions
   remain unresolved.
...
9. Wait for approval, write only approved RootSigil, validate it, and stop at the
   RootSigil review gate.
10. Only after RootSigil approval, focus on the requested component, classify its
    coverage, and gather task-specific evidence.
11. Report conflicting current and intended behavior and propose exact task Sigil
    before editing.
