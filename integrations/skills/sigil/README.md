...
Version 0.2.0 of the standalone pre-production Sigil workflow for Codex.
...
The skill requires compatible Sigil CLI and core 0.2.x packages and Sigil
0.2.0. See [compatibility.json](compatibility.json).

Plugin packaging and marketplace distribution are deferred beyond version 0.2.
