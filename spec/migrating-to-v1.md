...
4. Remove nested `.sigil/config.json` files from included paths, or exclude the entire
...
7. Update raw core parser calls to pass `{ sigilVersion: "0.1.0" }`.
